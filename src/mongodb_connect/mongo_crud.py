...
class mongo_operation:  # here i have create a class named as mongo_operation, so inside this mongo_operation class we have different methods or functions 
    ...
    def create_mongo_client(self,collection=None): # here i have create a fucntion named as create_mongo_client
        client=MongoClient(self.client_url)
        return client
    
    def create_database(self,collection=None): # here i have create a fucntion named as create_database
